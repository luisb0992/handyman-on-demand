<template>
    <section
        :class="
            topratedservice.length == 0
                ? 'our-customer-slider mar-top is-empty-review'
                : 'our-customer-slider mar-top'
        "
    >
        <div class="container">
            <div class="swiper-container customer-testimonial">
                <div class="swiper-wrapper">
                    ...
                    >
                        <div
                            class="row align-items-center row-cols-lg-2 row-cols-md-1 row-cols-1"
                        >
                            <div class="col">
                                <h3 class="tesimonial-title title-white">
                                    {{ __("messages.our_customers_says") }}
                                </h3>
...
export default {
    ...
    computed: {
        ...
        filteredRatings() {
            return this.topratedservice.length
                ? this.topratedservice.filter(
                      (rating) => rating.review !== null
                  )
                : [];
        },
    },
